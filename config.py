...
LEADERBOARD_ALL_TIMES = f'{LEADERBOARD_GAME_NAME}leaderboard'
LEADERBOARD_TIMESTAMPS = f'{LEADERBOARD_GAME_NAME}_timestamps'
LEADERBOARD_LAST_30_DAYS = f'{LEADERBOARD_GAME_NAME}_last_30_days'
